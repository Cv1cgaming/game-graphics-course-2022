...
const tex = await loadTexture("Autobot.png");
...
(async () => {
    ...
    let postDrawCall = app.createDrawCall(postProgram, postArray)
        ...
        .texture("noiseTex", app.createTexture2D(await loadTexture("Allspark.png")));
    ...
    let mirrorDrawCall = app.createDrawCall(mirrorProgram, mirrorArray)
        ...
        .texture("distortionMap", app.createTexture2D(await loadTexture("Decepticons.jpg")));
